        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-white/[0.08] gap-3 text-xs font-mono">
          <div className="flex items-center gap-1 overflow-x-auto pb-px">
            <button
              ...
              className={`px-3.5 py-2 rounded-t font-medium border-b-2 flex items-center gap-2 transition-all cursor-pointer ${
                activeTab === "audit"
                  ? "border-emerald-400 text-white bg-white/[0.03]"
          ...
          <div className="hidden md:flex items-center gap-2 text-[11px] text-slate-500">
            ...
            <span>Toggling charges reactively recalculates cash settlement via Convex</span>
          </div>
        </div>
